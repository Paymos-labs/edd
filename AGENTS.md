# AGENTS.md — Paymos for Easy Digital Downloads

Easy Digital Downloads payment gateway for Paymos stablecoin payments. Thin shell over
the bundled Paymos PHP SDK — the SDK owns signing, webhook verification, dedup and status mapping.
